...
The csv file is in the [data folder](https://github.com/donboyd5/taxdata-psl/tree/main/data) of the GitHub repo for this project [taxdata-psl project](https://github.com/donboyd5/taxdata-psl/tree/main).
