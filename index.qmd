...
The csv file is in the [data folder](https://github.com/donboyd5/irs_targets/tree/main/data) of the GitHub repo for this [irs_data project](https://github.com/donboyd5/taxdata-psl/tree/main).

The code that creates the csv file and this website is in the [targets_mockup folder](https://github.com/donboyd5/taxdata-psl/tree/main/targets_mockup) in Boyd's [taxdata-psl project](https://github.com/donboyd5/irs_targets/tree/main).
